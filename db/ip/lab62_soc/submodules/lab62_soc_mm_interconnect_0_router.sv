...
(
    ...
    // ( 0x8001180 .. 0x8001190 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 28'h8001180  && read_transaction  ) begin
            src_channel = 17'b00100000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 14;
    end

    // ( 0x8001190 .. 0x80011a0 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 28'h8001190  && read_transaction  ) begin
            src_channel = 17'b00010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 15;
    end

    // ( 0x80011a0 .. 0x80011b0 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 28'h80011a0   ) begin
    ...
    // ( 0x8001230 .. 0x8001238 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 28'h8001230   ) begin
            src_channel = 17'b00000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x8001238 .. 0x8001240 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 28'h8001238  && read_transaction  ) begin
